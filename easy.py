...
splash = random.choice(data.eass)
print(splash)

print('Easy mode')
print('Rules:')
print('To win you have to collect 500 points')
print('You can use helps ("ty" and "qw")')
print('Good answer + 10; bad answer - 10')
print('-200 points = you lose')
print('There are 2 levels: very easy and easy')

print('1. Very easy (10/10)')
print('2. Easy (20/10)')
op = True
while op:
    difficulty = input('Select difficulty: ')
    if difficulty == '1':
        e = random.choice(data.eses)
        print(e)
        ans = input('')
        if e == data.e1:
            if ans == '4':
